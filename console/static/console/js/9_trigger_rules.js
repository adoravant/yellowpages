...
function createRuleRow() {
    ...
    const updateSuggestions = () => {
        ...
        // coincidencias globales (incluye ID)
        ...
        // Seleccionar automáticamente el primer ítem que **no sea id** para la selección por defecto
...
window.resetBuilder = () => {
    ...
    if (jsonView) {
        jsonView.innerText = JSON.stringify({ group: "AND", nodes: [] }, null, 2);
    }

    if (mermaidContainer) {
        mermaidContainer.innerHTML = "<div style='opacity:0.4;font-size:12px'>Empty DNA</div>";
    }
